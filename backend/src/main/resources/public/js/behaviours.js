	...
	entcore_1.Behaviours.register('mindmap', {
	    ...
	    resource: function (resource) {
	        ...
	        for (var behaviour in mindmapBehaviours.resources) {
	            if (entcore_1.model.me.hasRight(rightsContainer, mindmapBehaviours.resources[behaviour]) || entcore_1.model.me.userId === resource.owner.userId || entcore_1.model.me.userId === rightsContainer.owner.userId) {
	        ...
	        return __awaiter(this, void 0, void 0, function () {
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    ...
	                    case 1:
	                        response = _a.sent();
	                        this.resources = response.data.map(function (e) { return ({
	                            title: e.name,
