package net.atos.entng.mindmap.core.constants;
...
public class Field {
     ...
     * MONGO_DB
     */
    public static final String FOLDER_CHILDREN = "folderChildren";
    ...
    public static final String FOLDER_CHILD_IDS = "folder_child_ids";
